...
convertListExpressions : List AudienceExpression -> NonEmpty AudienceExpression
convertListExpressions =
    NonemptyList.fromList
        >> Maybe.withDefault (NonemptyList.singleton Expression.AllRespondents)
...
notAffixedExpression : AudienceExpression
notAffixedExpression =
    Expression.Leaf
        { datapointCodes = [ XB2.Share.Data.Id.fromString "q2_1" ]
        , inclusion = Expression.Include
        , minCount = 1
        , questionCode = XB2.Share.Data.Id.fromString "q2"
        , suffixCodes = []
        }
...
diffInExpressions : AudienceExpression
diffInExpressions =
...
affixedExpression : AudienceExpression
affixedExpression =
    Expression.Node Expression.Or <|
        convertListExpressions
            [ Expression.Leaf
            ...
            , Expression.Node Expression.Or <|
                convertListExpressions
                    [ Expression.Leaf
                        { datapointCodes = [ XB2.Share.Data.Id.fromString "q2_2" ]
                        , inclusion = Expression.Include
                        , minCount = 1
                        , questionCode = XB2.Share.Data.Id.fromString "q2"
                        , suffixCodes = []
...
mockCrosstabProject =
    { data =
        ...
        , ownerId = ""
        , bases = NonemptyList.singleton projectAudienceData
        , metadata =
