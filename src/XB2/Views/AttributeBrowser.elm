...
getXBItemFromAttribute :
    Attribute
    -> XBItem
getXBItemFromAttribute { codes, questionName, suffixName, datapointName, namespaceCode } =
    { caption =
    ...
    , expression =
        Expression.Leaf
            ...
            , minCount = 1
            , questionCode = XB2.Share.Data.Labels.addNamespaceToQuestionCode namespaceCode codes.questionCode
            , datapointCodes =
                [ XB2.Share.Data.Labels.addQuestionToShortDatapointCode codes.questionCode codes.datapointCode
                ]
            , suffixCodes = Maybe.unwrap [] List.singleton codes.suffixCode
            }
