    ...
    case average of
        AvgWithoutSuffixes questionCode ->
            ...
            if List.isEmpty datapointCodes then
                ...
                , ( "audience", Maybe.unwrap Encode.null Expression.encodeV2 maybeAudience )
                , ( "locations", Encode.list XB2.Share.Data.Id.encode locationCodes )
                , ( "waves", Encode.list XB2.Share.Data.Id.encode waveCodes )
                , ( "base_audience", Encode.maybe (BaseAudience.getExpression >> Expression.encodeV2) baseAudience )
                ]
                    |> Encode.object
                    |> Ok
