...
getExpression : BaseAudience -> AudienceExpression
getExpression (BaseAudience { expression }) =
    expression


setExpression : AudienceExpression -> BaseAudience -> BaseAudience
...
default =
    fromSavedProject
        ...
        , name = XB2.Share.Data.Platform2.defaultAudienceName
        , fullName = XB2.Share.Data.Platform2.defaultAudienceName
