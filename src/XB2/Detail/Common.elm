...
getAudienceFolders : XB2.Share.Store.Platform2.Store -> IdDict AudienceFolderIdTag AudienceFolder
getAudienceFolders =
    .audienceFolders
        >> RemoteData.withDefault XB2.Share.Data.Id.emptyDict


{-| @TODO: This defaults to size expression. Not sure if that's correct...
-}
fromAudience : IdDict AudienceFolderIdTag AudienceFolder -> Audience -> Random.Seed -> ( AudienceItem, Random.Seed )
...
labelFromAudience : IdDict AudienceFolderIdTag AudienceFolder -> Audience -> Caption
    ...
    Caption.fromAudience
        ...
        , parent =
            case audience.folderId of
                ...
                Nothing ->
                    Just (XB2.Share.Data.Platform2.audienceTypeString audience)
        }
