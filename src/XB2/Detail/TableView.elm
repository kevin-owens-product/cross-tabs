...
import XB2.Share.Data.Audience.Expression exposing (AudienceExpression)
        ...
        [ Html.div
            ...
            (let
             ...
             if isDefault then
                ...
                , DropdownItem.viewIf baseAudienceExpressionIsNotEmpty
                    [ DropdownItem.class dropdownMenuClass
                    , DropdownItem.onClick (config.crosstabBases.openAffixModalForSingle baseAudience)
                    , DropdownItem.label "Affix base"
        ...
        , content =
            Html.div
                ...
                [ Html.div
                    ...
                    , DropdownItem.view
                        [ DropdownItem.class dropdownMenuClass
                        , DropdownItem.label "Affix to expression"
                        , DropdownItem.onClick (triggers.config.openAffixTableForSingle ( params.direction, params.key ))
                        , DropdownItem.leftIcon P2Icons.plusSign
                        ]
...
tableView triggers params =
    let
        ...
        renamingOnboardingView =
            Html.viewIf (List.length rowHeaders > 1)
...
viewCornerDatasets bases rows columns p2Store =
    let
        ...
        expressions : List AudienceExpression
        expressions =
            bases
                |> Zipper.map
                    (ACrosstab.unwrapCrosstabBase
