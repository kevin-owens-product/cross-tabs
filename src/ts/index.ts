...
import keysInit from "./initializer/keys";
import p2UrlInit from "./initializer/p2-url";
import analyticsInit from "./initializer/analytics";

import analyticsPorts from "./port/analytics";
import windowPorts from "./port/window";
import { monkeyPatchXtag } from "./helpers/webcomponents";
import { p2EnvPlatform } from "./helpers/platform";
import beforeUnloadConfirmPorts from "./port/beforeunload-confirm";
import scrollPorts from "./port/scroll";
import selectTextInFieldPorts from "./port/selectTextInField";
import intercomPorts from "./port/intercom";
import accessTokenHandler from "./port/accessToken";
import clipboardPorts from "./port/clipboard";
