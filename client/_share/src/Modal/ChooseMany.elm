module Modal.ChooseMany exposing (Config, Model, Msg, init, update, view)

import AssocSet as Set exposing (Set)
import Basics.Extra exposing (uncurry)
import Gwi.AssocSet as Set
...
import Modal.CheckboxItemView as ItemView
                ...
                [ Html.viewMaybe
                    (\link ->
                        Html.a
                            ...
                            [ Icons.icon [] P2Icons.help, Html.text "Help" ]
                    )
                    helpLink
