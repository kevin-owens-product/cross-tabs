module Error exposing (Exception(..), getDisplay, getExceptionType)

import Data.Core.Error as CoreError
import Dialog.ErrorDisplay exposing (ErrorDisplay)
import Dict
...
getDisplay customErrorDisplay error =
    case error of
        ...
        OtherError otherError ->
            { title = Gwi.Http.otherErrorTitle otherError
            , body = Html.text <| Gwi.Http.otherErrorToString otherError
            , details = []
            , errorId = Nothing
            }
