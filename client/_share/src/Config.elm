...
import Config.Main exposing (Stage)
import Data.User as User exposing (User)
import Json.Decode as Decode exposing (Decoder, Value)
import Json.Decode.Extra as Decode
import Maybe.Extra as Maybe
import Permissions exposing (Can)
...
decoder =
    Decode.succeed Flags
        ...
        |> Decode.andMap (Decode.field "env" Config.Main.envDecoder)
        ...
        |> Decode.andMap (Decode.map Permissions.fromUser (Decode.field "user" User.decoder))
